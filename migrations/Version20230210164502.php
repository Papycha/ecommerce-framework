 ...
 */
final class Version20230210164502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE products_details_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE images (id INT NOT NULL, products_id INT NOT NULL, name VARCHAR(55) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE products (id INT NOT NULL, categories_id INT NOT NULL, title VARCHAR(55) NOT NULL, genre VARCHAR(55) NOT NULL, author VARCHAR(55) NOT NULL, editor VARCHAR(55) NOT NULL, description TEXT NOT NULL, pages INT NOT NULL, isbn VARCHAR(55) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B3BA5A5AA21214B7 ON products (categories_id)');
        $this->addSql('CREATE TABLE products_details (id INT NOT NULL, products_id INT NOT NULL, format VARCHAR(20) NOT NULL, price INT NOT NULL, in_stock INT NOT NULL, date_pub DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A91BF1D76C8A81A9 ON products_details (products_id)');
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, conf_password VARCHAR(255) NOT NULL, lastname VARCHAR(50) NOT NULL, firstname VARCHAR(55) NOT NULL, phone VARCHAR(55) NOT NULL, address VARCHAR(55) NOT NULL, cp VARCHAR(30) NOT NULL, city VARCHAR(55) NOT NULL, siret VARCHAR(20) NOT NULL, role VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE products_details ADD CONSTRAINT FK_A91BF1D76C8A81A9 FOREIGN KEY (products_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE products_details_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE products_details DROP CONSTRAINT FK_A91BF1D76C8A81A9');
        ...
        $this->addSql('DROP TABLE products_details');
