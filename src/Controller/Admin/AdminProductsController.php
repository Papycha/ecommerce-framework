...
class AdminProductsController extends AbstractController
{
    ...
    #[Route('/admin/produits/ajout', name: 'admin_produits_add')]
    ...
    #[Route('/admin/produits/edition/{id}', name: 'admin_produits_edit')]
    ...
    #[Route('/admin/produits/suppression/{id}', name: 'admin_produits_delete')]
    ...
    // #[Route('/admin/produits/suppression/image/{id}', name: 'admin_produits_delete_image', methods: ['DELETE'])]
