...
class Coupons
{
    ...
    private ?\DateTimeInterface $vadility = null;
    ...
    public function getVadility(): ?\DateTimeInterface
    {
        return $this->vadility;
    }

    public function setVadility(\DateTimeInterface $vadility): self
    {
